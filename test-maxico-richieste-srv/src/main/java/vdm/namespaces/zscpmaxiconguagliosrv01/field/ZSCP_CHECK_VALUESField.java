...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.zscpmaxiconguagliosrv01.ZSCP_CHECK_VALUES ZSCP_CHECK_VALUES}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ZSCP_CHECK_VALUESField<FieldT >
    extends EntityField<ZSCP_CHECK_VALUES, FieldT>
    implements ZSCP_CHECK_VALUESSelectable
{
     ...
     */
    public ZSCP_CHECK_VALUESField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ZSCP_CHECK_VALUESField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
