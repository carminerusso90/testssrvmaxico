...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.zscpmaxiconguagliosrv01.ZSCP_CHECK_VALUES ZSCP_CHECK_VALUES} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.zscpmaxiconguagliosrv01.link.ZSCP_CHECK_VALUESLink ZSCP_CHECK_VALUESLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ZSCP_CHECK_VALUESOneToOneLink<ObjectT extends VdmObject<?> >
    extends ZSCP_CHECK_VALUESLink<ObjectT>
    implements OneToOneLink<ZSCP_CHECK_VALUES, ObjectT>
{
     ...
     */
    public ZSCP_CHECK_VALUESOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<ZSCP_CHECK_VALUES> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<ZSCP_CHECK_VALUES>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
